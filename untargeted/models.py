...
class SmoothInceptionV3Model(object):
    """Model class for CleverHans library."""
    ...
    def __call__(self, x_input, batch_size=None, is_training=False):
        ...
        with slim.arg_scope(inception.inception_v3_arg_scope()):
            with tf.variable_scope(self.name):
                avg_pooled = tf.nn.avg_pool(x_input, ksize=[1, 6, 6, 1], strides=[1, 1, 1, 1], padding='SAME')
                logits, end_points = inception.inception_v3(
                    avg_pooled, num_classes=self.num_classes, is_training=is_training,
                    reuse=reuse)
...
class SmoothEns3AdvInceptionV3Model(object):
    """Model class for CleverHans library."""
    ...
    def __init__(self, num_classes):
        ...
        self.logits = None
        self.ckpt = 'ens3_adv_inception_v3.ckpt'
        self.name = 'smooth_ens3_adv_inception_v3'
...
class SmoothEns4AdvInceptionV3Model(object):
    """Model class for CleverHans library."""
    ...
    def __init__(self, num_classes):
        ...
        self.logits = None
        self.ckpt = 'ens4_adv_inception_v3.ckpt'
        self.name = 'smooth_ens4_adv_inception_v3'
...
class JPEGInceptionResNetV2Model(object):
    """Model class for CleverHans library."""
    ...
    def __init__(self, num_classes, batch_size=None):
        ...
        self.logits = None
        self.ckpt = 'inception_resnet_v2_2016_08_30.ckpt'
        self.name = 'jpeg_inception_resnet_v2'
    ...
    def __call__(self, x_input, batch_size=None, is_training=False):
        ...
        with slim.arg_scope(inception.inception_resnet_v2_arg_scope()):
            with tf.variable_scope(self.name):
                compressed_image = tf_jpeg_utils.jpeg_compress_decompress(x_input)
                logits, end_points = inception.inception_resnet_v2(
                    compressed_image, num_classes=self.num_classes, is_training=is_training,
                    reuse=reuse)
...
class SmoothEnsAdvInceptionResNetV2Model(object):
    """Model class for CleverHans library."""
    ...
    def __init__(self, num_classes, batch_size=None):
        ...
        self.logits = None
        self.ckpt = 'ens_adv_inception_resnet_v2.ckpt'
        self.name = 'smooth_ens_adv_inception_resnet_v2'
...
class JPEGEnsAdvInceptionResNetV2Model(object):
    """Model class for CleverHans library."""
    ...
    def __init__(self, num_classes, batch_size=None):
        ...
        self.logits = None
        self.ckpt = 'ens_adv_inception_resnet_v2.ckpt'
        self.name = 'jpeg_ens_adv_inception_resnet_v2'
